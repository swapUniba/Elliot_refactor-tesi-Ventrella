...
class NeuMF(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/NeuRec results/Movielens/NeuMF_16/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/NeuRec results/DBbook/NeuMF_16/top_' + str(topK) + '_predictions_1.tsv'
