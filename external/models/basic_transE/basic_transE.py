...
class basic_transE(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Basic] TransE/TransE_768/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Basic] TransE-TransH/TransE_768/top_' + str(topK) + '_predictions_1.tsv'
