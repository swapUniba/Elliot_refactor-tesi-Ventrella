...
class TransE_USE_h2(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Hybrid2] TransE + USE/TransE + Guse_no_stopw/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Hybrid2] TransE-TransH + USE/TransE+GuseNostopw/top_' + str(topK) + '_predictions_1.tsv'
