...
class basic_USE(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Basic] USE/GUSE_nostopw/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Basic] BERT-USE/GUSE_nostopw/top_' + str(topK) + '_predictions_1.tsv'
