...
class MLP(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/NeuRec results/Movielens/MLP/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/NeuRec results/DBbook/MLP/top_' + str(topK) + '_predictions_1.tsv'
