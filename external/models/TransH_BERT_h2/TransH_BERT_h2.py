...
class TransH_BERT_h2(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ml = 'data/ventrella_experiment/testing/Movielens/[Hybrid2] TransH + BERT/TransH_lastLayerNoStopw/top_5_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Hybrid2] TransE-TransH + BERT/TransH_lastLayerNoStopw/top_5_predictions_1.tsv'
