...
class NAIS(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/NeuRec results/Movielens/NAIS_32/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/NeuRec results/DBbook/NAIS_16/top_' + str(topK) + '_predictions_1.tsv'
