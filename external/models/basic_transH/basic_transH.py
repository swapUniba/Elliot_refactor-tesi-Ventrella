...
class basic_transH(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Basic] TransH/TransH_768/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Basic] TransE-TransH/TransH_768/top_' + str(topK) + '_predictions_1.tsv'
