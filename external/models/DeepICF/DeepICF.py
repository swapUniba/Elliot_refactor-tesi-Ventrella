...
class DeepICF(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ml = 'data/ventrella_experiment/testing/NeuRec results/Movielens/DeepICF_16/top_5_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/NeuRec results/DBbook/DeepICF_16/top_5_predictions_1.tsv'
