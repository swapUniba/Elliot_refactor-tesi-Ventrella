...
class basic_BERT(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ml = 'data/ventrella_experiment/testing/Movielens/[Basic] BERT/concat_lastLayer_nostopwords/top_5_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Basic] BERT-USE/concat_lastlayer_nostopw/top_5_predictions_1.tsv'
