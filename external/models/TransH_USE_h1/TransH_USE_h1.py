...
class TransH_USE_h1(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Hybrid1] TransH + USE/TransH_GUSE/predictions/top_' + str(topK) + '/predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Hybrid1] TransE-TransH + USE/TransH_GUSE/predictions/top_' + str(topK) + '/predictions_1.tsv'
