...
class TransH_BERT_h1(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/Movielens/[Hybrid1] TransH + BERT/TransH_lastLayerNoStopw/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/DbBook/[Hybrid1] TransE-TransH + BERT/TransH_lastLayerNoStopw/top_' + str(topK) + '_predictions_1.tsv'
