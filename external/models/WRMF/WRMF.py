...
class WRMF(RecMixin, BaseRecommenderModel):
    ...
    def overwrite_train_dict(self):
        ...
        ml = 'data/ventrella_experiment/testing/NeuRec results/Movielens/WRMF_8/top_' + str(topK) + '_predictions_1.tsv'
        db = 'data/ventrella_experiment/testing/NeuRec results/DBbook/WRMF_8/top_' + str(topK) + '_predictions_1.tsv'
